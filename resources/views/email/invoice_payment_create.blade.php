                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style=" line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Subject : ') . 'We are writing to inform you that we have received your ' . $payment->invoice . ' payment.' }}</b>
                                                                        </p>
                                                                        <p style="line-height:32px"><b
                                                                                style="font-weight:700">{{ __('Dear ') . $payment->name . ',' }}</b>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal">{{ __('We appreciate your prompt payment and look forward to continued business with you in the future.') }}</i>
                                                                        </p>
                                                                        <p style="margin: 10px 0;"><i
                                                                                style="font-style:normal">{{ __('Thank you very much and have a good day.') }}</i>
                                                                        </p>
                                                                    </div>
                                                                </td>
                                                            </tr>
