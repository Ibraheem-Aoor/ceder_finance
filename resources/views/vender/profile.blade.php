                    ...
                    <div class="row">
                        ...
                        <div class="tab-content">
                            <div id="personal-info" class="tab-pane in active">
                                {{ Form::model($userDetail, ['route' => ['vender.update.profile'], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        {{ Form::text('contact', null, ['class' => 'form-control', 'placeholder' => __('Enter User Contact')]) }}
                                        @error('contact')
                                        ...
                                        <div class="form-group">
                                            <div class="choose-file">
                                                <label for="avatar">
                                                    ...
                                                    <input type="file" class="form-control" id="avatar" name="profile"
                            ...
                            <div id="billing-info" class="tab-pane">
                                {{ Form::model($userDetail, ['route' => ['vender.update.billing.info'], 'method' => 'post']) }}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('billing_name', __('Billing Name'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('billing_phone', __('Billing Phone'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('billing_zip', __('Billing Zip'), ['class' => 'form-control-label']) }}
                                            {{ Form::text('billing_zip', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing Zip')]) }}
                                            @error('billing_zip')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('billing_country', __('Billing Country'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('billing_state', __('Billing State'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('billing_city', __('Billing City'), ['class' => 'form-control-label']) }}
                            ...
                            <div id="shipping-info" class="tab-pane">
                                {{ Form::model($userDetail, ['route' => ['vender.update.shipping.info'], 'method' => 'post']) }}
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('shipping_name', __('Shipping Name'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('shipping_phone', __('Shipping Phone'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('shipping_zip', __('Shipping Zip'), ['class' => 'form-control-label']) }}
                                            {{ Form::text('shipping_zip', null, ['class' => 'form-control', 'placeholder' => __('Enter Shipping Zip')]) }}
                                            @error('shipping_zip')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('shipping_country', __('Shipping Country'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('shipping_state', __('Shipping State'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('shipping_city', __('Shipping City'), ['class' => 'form-control-label']) }}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            {{ Form::label('shipping_address', __('Shipping Address'), ['class' => 'form-control-label']) }}
                            ...
                            <div id="change-password" class="tab-pane">
                                {{ Form::model($userDetail, ['route' => ['vender.update.password', $userDetail->id], 'method' => 'post']) }}
                                <div class="row">
