<div class="card bg-none card-box">
    ...
    {{ Form::open(['url' => 'HR/employee', 'method' => 'post' , 'enctype' => 'multipart/form-data']) }}
    @csrf
                ...
                <div class="form-icon-user">
                    ...
                    <select name="salary_payment" id="salary_payment" class="form-control text-center" required>
                        ...
                        @foreach ($salary_payment_phases as $phase)
                            <option value="{{ $phase->value }}">{{ __($phase->name) }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    ...
                    {{ Form::file('id_file', null, ['class' => 'form-control', 'required' => 'required']) }}
