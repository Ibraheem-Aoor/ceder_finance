                ...
                <div class="card-body py-0 mt-2">
                    ...
                    <div class="row d-flex justify-content-end">
                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                            <div class="all-select-box">
                                <div class="btn-box">
                                    ...
                                    {{ Form::text('issue_date', isset($_GET['issue_date']) ? $_GET['issue_date'] : null, ['class' => 'form-control month-btn datepicker-range']) }}
                                </div>
                            </div>
                        </div>
                        @if (!\Auth::guard('customer')->check())
                        ...
                        <div class="col-auto my-auto">
                            ...
                            @if (!\Auth::guard('customer')->check())
                                <a href="{{ route('invoice.index') }}" class="reset-btn" data-toggle="tooltip"
                                ...
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        <td class="Id">
                                            @if (\Auth::guard('customer')->check())
                                                <a
                                                    href="{{ route('customer.invoice.show', \Crypt::encrypt($invoice->id)) }}">{{ AUth::user()->invoiceNumberFormat($invoice->invoice_id) }}</a>
                                            @else
                                                <a
