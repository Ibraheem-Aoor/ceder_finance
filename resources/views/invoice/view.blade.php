...
@section('content')
<a href="#" class="btn btn-sm btn-primary btn-icon rounded-pill cp_link" data-link="{{route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id))}}" data-toggle="tooltip" data-original-title="{{__('Click to copy invoice link')}}">
                            ...
                            <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        @endcan
                                        <small><i class="fas fa-clock mr-1"></i>{{__('Created on ')}} {{\Auth::user()->dateFormat($invoice->issue_date)}}</small>
                                    </div>
                                </div>
                                <div class="timeline-block">
                                    ...
                                    <div class="timeline-content">
                                        ...
                                        @if($invoice->status!=0)
                                            <small><i class="fas fa-clock mr-1"></i>{{__('Sent on')}} {{\Auth::user()->dateFormat($invoice->send_date)}}</small>
                                        @else
                                            @can('send invoice')
