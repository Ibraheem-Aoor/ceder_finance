                                    ...
                                    <div data-v-b8f60a0c="" class="col-33">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-b8f60a0c="">
                                                ...
                                                <td data-v-b8f60a0c="" class="text-right">{{\App\Models\Utility::invoiceNumberFormat($settings,$invoice->invoice_id)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$invoice->issue_date)}}</td>
                                            </tr>
                                            <tr data-v-b8f60a0c="">
                                                <td data-v-b8f60a0c="" class="tu fwb" style="color: {{$color}};">{{__('Due Date')}}:</td>
                                                <td data-v-b8f60a0c="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$invoice->due_date)}}</td>
                                            </tr>
