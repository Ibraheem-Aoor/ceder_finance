                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    {{ Form::select('item', $product_services,null, array('class' => 'form-control select2 item','data-url'=>route('bill.product'))) }}
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="blue-text text-right totalAmount">0.00</td>
                                <td></td>
                            </tr>
                            </tfoot>
                        </table>
