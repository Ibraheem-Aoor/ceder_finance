@php
    $company_logo = isAdmin('web')
        ? getImageUrl('uploads/logo/logo_white.png')
        ...
        <div class="div-mega">
            <ul class="navbar-nav navbar-nav-docs">
                    ...
                    @if (Gate::check('manage user') || Gate::check('manage role'))
                        <li class="nav-item">
                            <a class="nav-link {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'permissions' ? ' active' : 'collapsed' }}"
                                ...
                                aria-expanded="{{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'permissions' ? 'true' : 'false' }}"
                                aria-controls="navbar-staff">
                                <i class="fas fa-users"></i>{{ __('Staff') }}
                                <i class="fas fa-sort-up"></i>
                            </a>
                            <div class="collapse {{ Request::segment(1) == 'users' || Request::segment(1) == 'roles' || Request::segment(1) == 'permissions' ? 'show' : '' }}"
                                id="navbar-staff">
                ...
                @if (Gate::check('manage customer') || Gate::check('manage vender'))
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) == 'customer' || Request::segment(1) == 'vender' ? ' active' : 'collapsed' }}"
                            href="#navbar-relation" data-toggle="collapse" role="button"
                            aria-expanded="{{ Request::segment(1) == 'customer' || Request::segment(1) == 'vender' ? 'true' : 'false' }}"
                            aria-controls="navbar-relation">
                            <i class="fas fa-cubes"></i>{{ __('relation') }}
                            <i class="fas fa-sort-up"></i>
                        </a>
                        <div class="collapse {{ Request::segment(1) == 'customer' || Request::segment(1) == 'vender' ? 'show' : '' }}"
                            id="navbar-relation">
                            <ul class="nav flex-column submenu-ul">
                                ...
                                @if (Gate::check('manage vender'))
                                    <li class="nav-item">
                                        <a href="{{ route('vender.index') }}"
                                            class="nav-link {{ Request::segment(1) == 'vender' ? 'active' : '' }}">
            ...
            @can('manage invoice')
                <li class="nav-item ">
                    <a href="{{ route('invoice.index') }}"
                        class="nav-link {{ Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show' ? ' active' : '' }}"><i
                            class="fas fa-file-invoice-dollar"></i>{{ __('Invoice') }}</a>
                </li>
            @endcan
            ...
            <li class="nav-item">
                <a href="{{ route('customer.coming-soon') }}" class="nav-link">
                    <i class="fas fa-user-ninja"></i>{{ __('tax_authorities_link') }}
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('customer.coming-soon') }}" class="nav-link">
                    <i class="fas fa-user-ninja"></i>{{ __('ICP') }}
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('customer.coming-soon') }}" class="nav-link">
                    <i class="fas fa-user-ninja"></i>{{ __('company_decleration') }}
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('customer.coming-soon') }}" class="nav-link">
                    <i class="fas fa-user-ninja"></i>{{ __('income_tax') }}
                </a>
            </li>
            ...
            {{-- <li class="nav-item">
                <a href="{{ route('inbox.index') }}"
                    class="nav-link {{ Request::is('inbox*') ? 'active' : '' }}">
