                                ...
                                <div class="card-body pd-0">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            {{Form::text('company_name',null,array('class'=>'form-control font-style','required'=>'required'))}}
                                            @error('company_name')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            {{Form::text('company_email',null,array('class'=>'form-control','required'=>'required'))}}
                                            @error('company_email')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            {{Form::text('company_email_from_name',null,array('class'=>'form-control font-style','required'=>'required'))}}
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="custom-control custom-switch float-right">
                                                        {{Form::checkbox('customer_notification', '1',isset($settings['customer_notification']) && $settings['customer_notification'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'customer_notification'))}}
                                                        <label class="custom-control-label" for="customer_notification"></label>
                                                    </div>
                                                </li>
                                                <li class="list-group-item">
                                                    <span>{{__('Vendor create')}}</span>
                                                    <div class="custom-control custom-switch float-right">
                                                        {{Form::checkbox('vender_notification', '1',isset($settings['vender_notification']) && $settings['vender_notification'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'vender_notification'))}}
                                                        <label class="custom-control-label" for="vender_notification"></label>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="custom-control custom-switch float-right">
                                                        {{Form::checkbox('proposal_notification', '1',isset($settings['proposal_notification']) && $settings['proposal_notification'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'proposal_notification'))}}
                                                        <label class="custom-control-label" for="proposal_notification"></label>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="col-md-6">
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <div class="custom-control custom-switch float-right">
                                                        {{Form::checkbox('reminder_notification', '1',isset($settings['reminder_notification']) && $settings['reminder_notification'] == '1' ?'checked':'',array('class'=>'custom-control-input','id'=>'reminder_notification'))}}
                                                        <label class="custom-control-label" for="reminder_notification"></label>
                                                    </div>
                                                </li>
