                ...
                <div class="login-inner-contain">
                    ...
                    <div class="login-form">
                        <div class="page-title">
                            <h5><span>{{ __('Forgot') }}</span> {{ __('Password') }}</h5>
                        </div>
                    ...
                    <h5 class="copyright-text">
                        {{ App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : __('Copyright HRMGo') }}
                        {{ date('Y') }}
                    </h5>
                            ...
                            <select class="select-box"
                                ...
                                @foreach (App\Models\Utility::languages() as $language)
                                    <option @if ($lang == $language) selected @endif
                                        value="{{ route('customer.change.langPass', $language) }}">
